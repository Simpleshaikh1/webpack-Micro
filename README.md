...
**[WEBPACK Project]**
  The WEBPACK PROJECT is a simple folders and files that created to check the perfomance and efficiency of webpack packages using Node Package Manager (NPM), this project is created to initialize the project with webpack to work on a project using  tools without installing the package.
...
- cd my-folder
- git clone git@github.com:Simpleshaikh1/webpack-Micro.git
...
### Usage
make sure that you have node installed  in your local machine so that you can have access to using npm command.

Clone this repo,Open your IDE and run npm start : this command will start webpack dev-server that will watch any change made in dist folder so that it can reflect to the browser without refreshing the page.
...
show me your support by following me on github and giving me a star.Thank you .
